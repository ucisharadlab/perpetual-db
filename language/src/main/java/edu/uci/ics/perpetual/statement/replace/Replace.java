...
package edu.uci.ics.perpetual.statement.replace;
...
public class Replace implements Statement {
    ...
    /**
     * A list of {@link edu.uci.ics.perpetual.schema.Column}s either from a "REPLACE mytab (col1, col2)
     * [...]" or a "REPLACE mytab SET col1=exp1, col2=exp2".
     *
     * @return a list of {@link edu.uci.ics.perpetual.schema.Column}s
     */
    ...
    /**
     * A list of {@link edu.uci.ics.perpetual.expression.Expression}s (from a "REPLACE mytab SET
