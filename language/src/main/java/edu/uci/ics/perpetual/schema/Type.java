 ...
 */
public class Type extends ASTNodeAccessImpl implements FromItem, MultiPartName {
...
//    private String name;
    ...
    public Type(String schemaName, String name) {
        setIndex(NAME_IDX, name);
        setIndex(SCHEMA_IDX, schemaName);
    }

    public Type(Database database, String schemaName, String name) {
        setIndex(NAME_IDX, name);
        setIndex(SCHEMA_IDX, schemaName);
    ...
    public Type(List<String> partItems) {
